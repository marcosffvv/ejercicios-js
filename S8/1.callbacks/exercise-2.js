...
//La función father deberá ejecutar la función que reciba como callback y añadir el valor resultado que retorne la función al array userAnwsers. Ejecuta varias veces la función father y haz finalmente un console.log de userAnwsers
...
father('Holaaaaaaaaa', confirmExample)
father('que pasaaaaa', promptExample)
father('estooooooo', confirmExample)
father('fracasaaaaa', promptExample)
