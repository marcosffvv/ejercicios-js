...
const filtrador$$ = document.querySelector('input');

const filtracion = streamers.filter(
    streamer =>
    streamer.name.toLowerCase().includes(filtrador$$.value().toLowerCase)
    );

filtrador$$.addEventListener('input', filtracion);
