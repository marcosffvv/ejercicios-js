...
for (let i = 0; i < users.length; i++) {
    if (users[i].years >= 18){
        console.log(users[i].name + ' es mayor de edad, ya que tiene ' + users[i].years + ' años');
    }
    else console.log(users[i].name + ' es menor de edad ya que tiene' + users[i].years + ' años');   
}